...
TOPICS = {'temp': ('/sensors/temperature', QOS_1), 'temp_setpoint' : ('/user/control_policy', QOS_1), 'ping' : ('ping_topic', QOS_1), 'controller' : ('/controller', QOS_1)}
...
SENSOR_SAMPLING_INTERVAL_S = 60
LOGGER_INTERVAL_S = 60
CONTROLLER_SAMPLING_INTERVAL_S = 60
